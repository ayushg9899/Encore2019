...
import iet.lucknow.encore2019.MainActivity;
...
public class FirebaseMessagingService extends com.google.firebase.messaging.FirebaseMessagingService  {
    ...
    private void sendNotification(String title,String messageBody, String click_action, String jsonMessage) {
        Intent intent;
        notification.title = title;
        notification.message = messageBody;
        notification.info = jsonMessage;
